...
Feature: Discounts Validations
  ...
  #############################   Item Based - Discount Validation  - Standard Item  #############################
  ...
  Scenario: Verify the discount value - Item Based Discount for Before Tax - "10" percentage with Free Item as "Standard Item 1"
    ...
    #############################   Item Based - Discount Validation  - Variant Item  #############################
  ...
  Scenario: Verify the discount value - Item Based Discount for Before Tax - "10" percentage with Free Item as "Standard Item 1"
    ...
    And Click the Logoff button
        ...
        #############################   Item Based - Discount Validation  - Kit Assembly Item  #############################
  Scenario: Verify the discount value - Item Based Discount for After Tax - "10" percentage with discount amount "1.75"
    Given Login with the valid credentials
  ...
  Scenario: Verify the discount value - Item Based Discount for Before Tax - "10" percentage with Free Item as "Standard Item 1"
    ...
    And Click the Logoff button
      ...
      #############################   Item Based - Discount Validation  - Standard and Variant Item  #############################
  Scenario: Verify the discount value - Item Based Discount for After Tax - "10" percentage with discount amount "1.75"
    Given Login with the valid credentials
    Then Order the Standard Item from the retail Screen
    Then Order the Variant item from the retail Screen
  ...
  Scenario: Verify the discount value - Item Based Discount for Before Tax - "10" percentage with Free Item as "Standard Item 1"
    ...
    And Click the Logoff button
        ...
        #############################   Check Based - Discount Validation - Standard Item  #############################
  ...
  Scenario: Verify the discount value - Check Based Discount for Before Tax - "10" percentage with Free Item as "Standard Item 1"
    ...
    #############################   Check Based - Discount Validation - Variant Item  #############################
  ...
  Scenario: Verify the discount value - Check Based Discount for Before Tax - "10" percentage with Free Item as "Standard Item 1"
    ...
    And Click the Logoff button
        ...
        #############################   Check Based - Discount Validation - Kit Assembly Item  #############################
...
#
      ...
      #############################   Mix and Max Based - Discount Validation - Standard Item  #############################
  Scenario: Verify the discount value - Mix And Match Discount for After Tax - "10" percentage with Set Price as "11.75" and minimum quantity is "2"
    Given Login with the valid credentials
    Then Order the Standard Item from the retail Screen
    When Click the Discount Option from the given options
    ...
    And Click the cancel button
    And Calculate the value of Mix And Match Discount for After Tax - "10" percentage with Set Price as "11.75" and minimum quantity is "2"
    Then Complete the payment using fast cash button
    And Click the Logoff button

  Scenario: Verify the discount value - Mix And Match Discount for After Tax - "10" percentage with Set Each Item Price as "8.25" and minimum quantity is "2"
    Given Login with the valid credentials
    Then Order the Standard Item from the retail Screen
    When Click the Discount Option from the given options
    ...
    And Click the cancel button
    And Calculate the value of Mix And Match Discount for After Tax - "10" percentage with Set Each Item Price as "8.25" and minimum quantity is "2"
    Then Complete the payment using fast cash button
    And Click the Logoff button

  Scenario: Verify the discount value - Mix And Match Discount for After Tax - "10" percentage with Set Percentage as "7" Least Expensive and minimum quantity is "2"
    Given Login with the valid credentials
    Then Order the Standard Item from the retail Screen
    When Click the Discount Option from the given options
    ...
    And Click the cancel button
    And Calculate the value of Mix And Match Discount for After Tax - "10" percentage with Set Percentage as "7" Least Expensive and minimum quantity is "2"
    Then Complete the payment using fast cash button
    And Click the Logoff button

  Scenario: Verify the discount value - Mix And Match Discount for After Tax - "10" percentage with Set Percentage as "7" Most Expensive and minimum quantity is "2"
    Given Login with the valid credentials
    Then Order the Standard Item from the retail Screen
    When Click the Discount Option from the given options
    ...
    And Click the cancel button
    And Calculate the value of Mix And Match Discount for After Tax - "10" percentage with Set Percentage as "7" Most Expensive and minimum quantity is "2"
    Then Complete the payment using fast cash button
    And Click the Logoff button

  Scenario: Verify the discount value - Mix And Match Discount for Before Tax - "10" percentage with Set Price as "11.75" and minimum quantity is "2"
    Given Login with the valid credentials
    Then Order the Standard Item from the retail Screen
    When Click the Discount Option from the given options
    ...
    And Click the cancel button
    And Calculate the value of Mix And Match Discount for Before Tax - "10" percentage with Set Price as "11.75" and minimum quantity is "2"
    Then Complete the payment using fast cash button
    And Click the Logoff button

  Scenario: Verify the discount value - Mix And Match Discount for Before Tax - "10" percentage with Set Each Item Price as "8.25" and minimum quantity is "2"
    Given Login with the valid credentials
    Then Order the Standard Item from the retail Screen
    When Click the Discount Option from the given options
    ...
    And Click the cancel button
    And Calculate the value of Mix And Match Discount for Before Tax - "10" percentage with Set Each Item Price as "8.25" and minimum quantity is "2"
    Then Complete the payment using fast cash button
    And Click the Logoff button

  Scenario: Verify the discount value - Mix And Match Discount for Before Tax - "10" percentage with Set Percentage as "7" Least Expensive and minimum quantity is "2"
    Given Login with the valid credentials
    Then Order the Standard Item from the retail Screen
    When Click the Discount Option from the given options
    ...
    And Click the cancel button
    And Calculate the value of Mix And Match Discount for Before Tax - "10" percentage with Set Percentage as "7" Least Expensive and minimum quantity is "2"
    Then Complete the payment using fast cash button
    And Click the Logoff button

  Scenario: Verify the discount value - Mix And Match Discount for Before Tax - "10" percentage with Set Percentage as "7" Most Expensive and minimum quantity is "2"
    Given Login with the valid credentials
    Then Order the Standard Item from the retail Screen
    When Click the Discount Option from the given options
    ...
    And Click the cancel button
    And Calculate the value of Mix And Match Discount for Before Tax - "10" percentage with Set Percentage as "7" Most Expensive and minimum quantity is "2"
    Then Complete the payment using fast cash button
    And Click the Logoff button

          #############################   Mix and Max Based - Discount Validation - Variant Item  #############################
  Scenario: Verify the discount value - Mix And Match Discount for After Tax - "10" percentage with Set Price as "11.75" and minimum quantity is "2"
    Given Login with the valid credentials
    Then Order the Variant item from the retail Screen
    When Click the Discount Option from the given options
  ...
  Scenario: Verify the discount value - Mix And Match Discount for Before Tax - "10" percentage with Set Percentage as "7" Most Expensive and minimum quantity is "2"
    ...
    And Click the Logoff button
      ...
      #############################   Mix and Max Based - Discount Validation - Kit Assembly Item  #############################
  Scenario: Verify the discount value - Mix And Match Discount for After Tax - "10" percentage with Set Price as "11.75" and minimum quantity is "2"
    Given Login with the valid credentials
    Then Order the Kit Assembly item from the retail Screen
    When Click the Discount Option from the given options
  ...
  Scenario: Verify the discount value - Mix And Match Discount for After Tax - "10" percentage with Set Percentage as "7" With Combo Discounts
    Given Login with the valid credentials
    Then Order the Combo Item "MAM_AT_PER_C" from the retail Screen
  ...
  Scenario: Verify the discount value - Mix And Match Discount for After Tax - "10" percentage with Set Price as "11.75" With Combo Discounts
    Given Login with the valid credentials
    Then Order the Combo Item "MAM_AT_SP_C" from the retail Screen
  ...
  Scenario: Verify the discount value - Mix And Match Discount for Before Tax - "10" percentage with Set Percentage as "7" With Combo Discounts
    Given Login with the valid credentials
    Then Order the Combo Item "MAM_BT_PER_C" from the retail Screen
  ...
  Scenario: Verify the discount value - Mix And Match Discount for Before Tax - "10" percentage with Set Price as "11.75" With Combo Discounts
    Given Login with the valid credentials
    Then Order the Combo Item "MAM_BT_SP_C" from the retail Screen
