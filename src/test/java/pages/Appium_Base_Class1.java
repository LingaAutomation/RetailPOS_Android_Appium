...
public class Appium_Base_Class1 {
...
//		PageFactory.initElements(new And);
	}

//	public void Appium_driver() throws Throwable {
...
////		driver = new AndroidDriver(new URL(Utility.getProperty("Appium_URL")), cap);
...
//
//			// Selecting random value
//			// click_Ele((WebElement) itemsInDropdown.get(selectUniqueRandomNumbers(size,size-1)));
//
//
//		// Generate a random number with in range
...
//
//		// Selecting random value
//		click_Ele((WebElement) itemsInDropdown.get(randnMumber1));
//
//		Thread.sleep(2000);
//
//		// Generate a random number with in range
...
//
//		// Selecting random value
//		click_Ele((WebElement) itemsInDropdown.get(randnMumber2));
//
//		Thread.sleep(2000);
//
//		// Generate a random number with in range
//		int randnMumber3 = ThreadLocalRandom.current().nextInt(1, size);
//
//		// Selecting random value
//		click_Ele((WebElement) itemsInDropdown.get(randnMumber3));
	}
...
//					click_Ele((WebElement) driver.findElement(By.xpath("//*[@text='Cash']")));
//					click_Ele((WebElement) driver.findElement(By.xpath("//*[@text='Cash']")));
//					click_Ele((WebElement) driver.findElement(By.xpath("//*[@resource-id='background-content']/../android.view.View/android.view.View[2]/android.view.View[1]/android.widget.Button")));
//					click_Ele((WebElement) driver.findElement(By.xpath("//*[@text='Enter']")));
					if(i != size) {
