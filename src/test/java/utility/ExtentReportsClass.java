...
public class ExtentReportsClass{
	...
	public void startReport(){
		...
		extent
                .addSystemInfo("Host Name", "Linga Retail")
                .addSystemInfo("Environment", "Automation Testing")
                .addSystemInfo("User Name", "Linga");
                //loading the external xml file (i.e., ExtentConfig.xml) which was placed under the base directory
